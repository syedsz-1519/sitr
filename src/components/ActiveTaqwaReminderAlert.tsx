...
export const ActiveTaqwaReminderAlert: React.FC<ActiveTaqwaReminderAlertProps> = ({ onNavigate }) => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/80 backdrop-blur-md animate-fadeIn">
      <div className="w-full max-w-lg rounded-3xl bg-gradient-to-b from-[#1C1133] via-[#140B26] to-[#0D061A] border border-amber-500/40 p-6 sm:p-7 shadow-2xl shadow-purple-950/80 relative overflow-hidden">
          ...
          <div className="flex items-center gap-2.5">
            ...
            <div>
              <div className="flex items-center gap-2">
                ...
                <span className="text-[10px] px-2 py-0.5 rounded-full bg-purple-900/50 text-purple-200 border border-purple-700/40 capitalize">
        ...
        <div className="py-5 space-y-4">
          ...
          {activeTaqwaReminder.arabic && (
            <div className="p-4 rounded-2xl bg-[#0F071C]/80 border border-amber-500/20 text-center">
              <p className="font-arabic text-xl sm:text-2xl text-amber-200 font-bold leading-loose" dir="rtl">
                {activeTaqwaReminder.arabic}
              </p>
            </div>
          )}
          ...
          <div className="p-4 rounded-2xl bg-[#170C2E]/60 border border-purple-900/40 space-y-2">
            <p className="text-sm text-purple-100 font-serif leading-relaxed italic">
              “{activeTaqwaReminder.text}”
            </p>
            <div className="flex items-center justify-between pt-2 border-t border-purple-900/20 text-[11px] text-purple-300/80 font-metric">
              <span className="font-medium text-amber-300/90">{activeTaqwaReminder.source}</span>
              {activeTaqwaReminder.category && (
                <span className="text-[10px] text-purple-400 bg-purple-950/60 px-2 py-0.5 rounded-md border border-purple-800/30">
                  {activeTaqwaReminder.category}
                </span>
              )}
            </div>
        ...
        <div className="pt-2 flex flex-col sm:flex-row gap-2.5">
          <button
            ...
            className="flex-1 py-3 px-4 rounded-xl bg-gradient-to-r from-amber-500 to-purple-600 hover:from-amber-400 hover:to-purple-500 text-white text-xs font-bold font-metric transition-all shadow-lg shadow-purple-900/40 flex items-center justify-center gap-2"
          >
          ...
          <button
            ...
            className="py-3 px-4 rounded-xl bg-[#23173D] hover:bg-[#2C1D4C] text-purple-200 hover:text-white text-xs font-semibold font-metric transition-colors border border-purple-700/40 flex items-center justify-center gap-2"
          >
          ...
          <button
            onClick={dismissTaqwaReminder}
            className="py-3 px-4 rounded-xl bg-transparent hover:bg-white/5 text-purple-400 hover:text-purple-200 text-xs font-metric transition-colors"
          >
            Dismiss
          </button>
        </div>
