    ...
    <div className="space-y-6 pb-12">
      ...
      <div>
        <div className="flex items-center gap-2">
          ...
          <h1 className="text-lg font-bold text-white">Jihad al-Nafs Challenges</h1>
        </div>
        ...
        {challenges.map((ch) => (
          <div
            ...
            className={`p-5 rounded-2xl border transition-all ${
              ch.completed
                ? 'bg-[#1E1433] border-emerald-500/40 shadow-sm'
                : 'bg-[#170F26] border-purple-900/30'
            }`}
          >
            <div className="flex items-start justify-between gap-3">
              <div>
                ...
                <p className="text-xs text-purple-200/80 mt-1 leading-relaxed">{ch.subtitle}</p>
              </div>
              ...
              <button
                ...
                className={`w-7 h-7 rounded-xl flex items-center justify-center border transition-all shrink-0 ${
                  ch.completed
                    ...
                    : 'bg-[#120B1C] text-purple-400/40 border-purple-900/40 hover:text-purple-300'
                }`}
              >
